...
#line 89 "www/solutions/uarray2.nw"
...
#line 105 "www/solutions/uarray2.nw"
...
#line 126 "www/solutions/uarray2.nw"
...
#line 181 "www/solutions/uarray2.nw"
void UArray2_map_row_major(T array2, 
  ...
  for (int j = 0; j < h; j++) {
    UArray_T thisrow = row(array2, j); // don't want row/UArray_at in inner loop
    for (int i = 0; i < w; i++)
      apply(i, j, array2, UArray_at(thisrow, i), cl);
  }
}
#line 195 "www/solutions/uarray2.nw"
